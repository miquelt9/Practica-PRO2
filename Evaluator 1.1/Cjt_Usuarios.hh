...
public:
  ...
  */
  ...
  /** @brief Inscribir usuario a curso
      ...
      \post El usuario u está inscrito al curso c
  */
  void inscribir_curso(const int& c, const string& u,
  ...
  */
  void envio(const string& u, const string& p, const int& r, Cjt_Problemas& problemas);
