...
public:
  ...
  */
  Sesion consultar_sesion(const string& s);
  ...
  */
  ...
  /** @brief Sesion del problema
      ...
      \pre  Cierto
      \post Devuelve el identificador (string) al que pertenece el problema,
            si el problema no existiera en ninguna de las sesiones se devuelve
            un "-1"
  */
  string sesion_problema(const vector<string>, cosnt string& problema) const;
