...
private:
  /**@brief Mapa de problemas de acceso según su id*/
  map<string,Problema> problemas;
  /**@brief Bit de modificacion*/
  bool modificado;
  /**@brief Mapa de problemas ordenados por su ratio i id*/
  map<pair<double,string>,Problema> ordenados;
};
