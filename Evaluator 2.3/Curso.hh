...
private:
  /**@brief Id del curso*/
  int id;
  /**@brief Lista de las sesiones del curso*/
  list<string> sesiones_del_curso;
  /**@brief Mapa de acceso por id de problema i de valor la sesion del problema*/
  map<string,string> map_problema_sesion;
  /**@brief Numero de usuarios registrados*/
  int usuarios_registrados;
  /**@brief Set de los id de los usuarios que han completado el curso*/
