...
public:
  ...
  */
  ...
  /** @brief Envio
      ...
      \pre  Cierto
      \post Se actualizan las estadísticas del usuario i del problema enviado,
  ...
  */
  void agregar_enviables(list<string>& ls, const Cjt_Cursos& cursos,
...
private:
  ...
  string id;
  /**@brief Identificador del curso inscrito*/
  int curso;
  /**@brief Mapa de los problemas enviables, con el valor igual al numero de envios
            realizados a cada key (problema)*/
  map<string,int> enviables;
  /**@brief Mapa de los problemas resueltos con el valor igual al numero de envios
            realizados a cada key (problema)*/
  map<string,int> resueltos;
  /**@brief Vector de seiones completadas*/
